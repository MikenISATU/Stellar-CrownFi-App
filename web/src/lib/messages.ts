...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  market_payouts_pending: "This resolved market still has winnings waiting to be claimed and cannot be deleted yet.",
  legacy_market_refunds_require_claim: "This earlier market was cancelled safely. Its original contract requires participants to sign and claim their refunds before it can be deleted.",
  force_refund_incomplete: "The market was cancelled, but some wallet refunds could not be completed automatically. It remains available for those users to claim.",
